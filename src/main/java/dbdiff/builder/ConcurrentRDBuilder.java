...
public enum ConcurrentRDBuilder {;
    ...
    public static RelationalDatabase createRelationalDatabase(DatabaseMetaData metadata, CatalogSchema catalogSchema) throws SQLException {
        final var tables = getAllTables(metadata, catalogSchema);
    ...
    private static List<RelationalTable> getAllTables(final DatabaseMetaData metadata, final CatalogSchema catalogSchema) throws SQLException {
        // Get the ResultSet of tables
        String[] tableTypes = {TableType.TABLE.name()};
        ResultSet rs = doGetTablesQuery(metadata, catalogSchema, tableTypes);
    ...
    protected static ResultSet doGetTablesQuery(DatabaseMetaData metadata, CatalogSchema catalogSchema, String[] tableTypes) throws SQLException {
        return metadata.getTables(catalogSchema.getCatalog(), catalogSchema.getSchema(), null, tableTypes);
    }
